...
<head>
  ...
  <style>
    * {
    ...
    .form-card input:focus, .form-card textarea:focus, .form-card select:focus { border-color: #00c2c7; }
    ...
    .quantidade-atual span {
      display: block;
      font-size: 13px;
      color: #666;
    }
    .quantidade-atual strong {
      display: block;
      font-size: 30px;
      color: #006d77;
      margin-top: 4px;
    ...
    .entrada label { color: #287a44; }
    .entrada input { border-color: #3a9d5d; background: white; }

    .saida {
      background: #fff0f0;
      border: 2px solid #d9534f;
    }
    .saida label { color: #b52b27; }
    .saida input { border-color: #d9534f; background: white; }
    ...
    @media (max-width: 600px) {
      .movimentacao { grid-template-columns: 1fr; }
      header { padding: 0 15px; }
      .menu-superior { gap: 5px; }
      .menu-superior a { padding: 8px 12px; font-size: 13px; }
    }
      ...
      <form action="painel_editarcompbd.php" method="POST" enctype="multipart/form-data"> 
        ...
        <div class="movimentacao"> 
          <div class="entrada">
            ...
            <input type="number" name="entrada" min="0" value="0" placeholder="Ex.: 10">
          </div> 

          <div class="saida"> 
            <label>Retirar</label> 
            <input type="number" name="saida" min="0" max="<?php echo $dados['QUANTIDADE']; ?>" value="0" placeholder="Ex.: 2">
          </div> 
        </div>
        ...
        <div class="info">
          A quantidade atual será atualizada automaticamente conforme a entrada ou saída informada.
        </div>
