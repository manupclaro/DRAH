...
<style>
    * {
    ...
    .comp-image {
        width: 100%;
        height: 220px;
        background: linear-gradient(135deg, #ffb084 0%, #ff7f50 100%);
        display: flex;
        align-items: center;
    ...
    .comp-image-horizontal {
        ...
        height: 150px;
        border-radius: 12px;
        background: linear-gradient(135deg, #ffb084, #ff7f50);
        font-size: 70px;
        display: flex;
        align-items: center;
        justify-content: center;
